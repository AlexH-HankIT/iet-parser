...
class Diff
{
    ...
    public static function compare($string1, $string2, $compareCharacters = false)
    {
        ...
        $table = self::_computeTable($sequence1, $sequence2, $start, $end1, $end2);

        // generate the partial diff
        $partialDiff = self::_generatePartialDiff(
            $table,
            $sequence1,
            $sequence2,
            $start
     ...
     * @return string
     */
    private static function _computeTable(
        $sequence1,
        $sequence2,
        $start,
        $end1,
     ...
     * @return string
     */
    private static function _generatePartialDiff(
        $table,
        $sequence1,
        $sequence2,
        $start
    ...
    public static function toTable($diff, $indentation = '', $separator = '<br>')
    {
        ...
        while ($index < count($diff)) {
            ...
            case self::DELETED:
                ...
                $rightCell = self::_getCellContent(
                    $diff,
                    $indentation,
                    $separator,
                    $index,
     ...
     *                            every line of the generated HTML
     * @param string $separator   the separator between lines
     ...
     * @return string
     */
    private static function _getCellContent(
        $diff,
        $indentation,
        $separator,
        &$index,
